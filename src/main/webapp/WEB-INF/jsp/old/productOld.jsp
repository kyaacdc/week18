...
<main>
    ...
    <div>
        <form role="form" class="form-horizontal" method="POST" action="/oneClickBuy">
                <h3><em>One click Buy</em></h3>
        <label>Email</label> <input name="email" type="text" placeholder="email" value=${email}> * ${wrongEmail}<br>
